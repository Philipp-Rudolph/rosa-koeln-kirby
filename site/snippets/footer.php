...
<footer class="footer">
  ...
  <div class="footer__bottom">
      ...
      <div class="footer__section">
        <div class="social-links">
          <?php if ($site->facebook()->isNotEmpty()): ?>
            <a href="<?= $site->facebook() ?>" target="_blank" aria-label="Facebook">
    ...
    <?php endif ?>
    <p>&copy; <?= date('Y') ?> <?= $site->title() ?>. Alle Rechte vorbehalten.</p>
    <p>
...
<script type="module" src="<?= url('assets/js/script.js') ?>"></script>
</body>
